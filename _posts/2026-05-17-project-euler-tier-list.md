...
[Problem 1000](https://projecteuler.net/problem=1000) of Project Euler is releasing this weekend! To celebrate (and lightly brag about being a [perfectionist]({% post_url 2025-10-22-project-euler-perfection %}) :P), here's a *super* serious tier list of every single PE problem.
...
Lastly, for any special occasion, I'm basically obligated to write something cheesy and sentimental, so all my rambling will go in [the appendix]({% post_url 2026-05-17-perfectionist-thoughts %}).
...
---
{: style="margin-top: 1.25rem; margin-bottom: 3rem;"}
...
---
{: style="margin-top: 3rem; margin-bottom: 1.75rem;"}

*So... many... problems...*
{: style="margin-bottom: 0rem; font-size: 1.8rem; text-align: center"}

{: style="margin-top: 0rem; margin-bottom: 2.1rem;"}
{% include image.html name="so-many-problems.png" width="27rem" %}