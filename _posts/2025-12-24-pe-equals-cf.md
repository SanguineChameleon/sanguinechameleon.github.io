...
> **Note**: This is an appendix to [New Year, New Me (Allegedly)]({% post_url 2025-12-24-new-year-2026 %}), but it can be read on its own. I assume you already know what Project Euler and Codeforces (more generally, competitive programming) are.

## Prologue

In [ye olden days]({% post_url 2025-05-12-problem-solving %}), I said:
...
This post will <span style="text-decoration: underline">not</span>, in any way, attempt to compare them. I will not be using any examples from either website.
...
So throughout the grind, there were moments where I'd be stuck on a problem for a long while, [get upset at myself]({% post_url 2025-09-02-i-will-solve-it %}), and have no one else to talk to about it.
...
After I made my [post]({% post_url 2025-10-22-project-euler-perfection %}) celebrating, some people asked me what my next goal is. So I absent-mindedly said:
...
Now, I would do a terrible job at explaining the [gambler's fallacy](https://en.wikipedia.org/wiki/Gambler%27s_fallacy), but just hear me out.
...
How should I end this... I'll take the closing line from [my old post]({% post_url 2025-05-12-problem-solving %}):
